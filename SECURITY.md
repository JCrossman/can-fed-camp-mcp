...
1. Go to the **[Security tab](https://github.com/JCrossman/can-fed-camp-mcp/security)**
   of this repository.
...
These map directly to the binding
[Constitution](https://github.com/JCrossman/the-open-state/blob/main/CONSTITUTION.md)
(Articles 1, 2, 5, 9, 10). A report that demonstrates a constitutional violation is,
...
- The browser-like User-Agent the camping implementation sends (a documented,
  honestly-recorded tension — see [`README.md`](README.md) "Honest notes").
